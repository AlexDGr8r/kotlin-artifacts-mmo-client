      ...
      <div className="grid">
        ...
        <section className="panel">
          <div className="panel-inner stack">
            ...
            <div className="row wrap fill">
              <button className="btn btn-primary" onClick={fetchRoutine} disabled={!name || loadingRoutine}>
            ...
            <div className="stack">
              ...
              {currentRoutine ? (
                ...
                <div className="helper">{name ? 'No routine for this character.' : 'Select a character to view routine.'}</div>
              )}
            </div>
          </div>
        </section>
        ...
        <section className="panel">
          <div className="panel-inner stack">
            ...
            <div className="stack">
              <label className="input-label" htmlFor="durationMinutes">Duration (minutes, optional)</label>
              <input
                id="durationMinutes"
