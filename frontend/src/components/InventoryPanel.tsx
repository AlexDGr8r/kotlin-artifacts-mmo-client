...
export function InventoryPanel({
    ...
    onFindRecipes: (code: string) => void;
}) {
        ...
        <section className="card full-bleed">
            <div className="card-header">
                ...
                <div className="row wrap">
                    <button className="btn" onClick={onReload} disabled={!isReady || loading}><Icon name="refresh"/>Reload
                    </button>
                            ...
                            <div key={slotNum} className="inv-slot">
                                <div className="inv-slot-header">
                                    ...
                                    {Number.isFinite(displayLevel as any) &&
                                        <span className="badge">Lvl {displayLevel}</span>}
                                </div>
                                ...
                                <div className="inv-slot-actions" style={{gap: 6}}>
                                    <select
                                        ...
                                        onChange={(e) => setEquipTargetByInvSlot(prev => ({
                                            ...prev,
                                            [Number(slotNum)]: e.target.value
                                        }))}
